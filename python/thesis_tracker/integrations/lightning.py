"""PyTorch Lightning callback.
    ...
    trainer = Trainer(callbacks=[ThesisTrackerCallback(project="My Thesis")])
...
try:  # support both the new `lightning` and legacy `pytorch_lightning`
    ...
    try:
        ...
        raise ImportError(
            ...
            "Install it with: pip install 'thesis-tracker[lightning]'"
        ) from exc

from ._common import RunSession, to_scalars


class ThesisTrackerCallback(Callback):
    def __init__(
        self,
        name: str | None = None,
        *,
