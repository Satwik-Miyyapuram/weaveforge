"""Keras callback (Keras 3 or tf.keras).
    ...
    model.fit(..., callbacks=[ThesisTrackerCallback(name="cnn", project="My Thesis")])
...
try:
    ...
    try:
        ...
        raise ImportError(
            ...
            "Install it with: pip install 'thesis-tracker[keras]'"
        ) from exc

from ._common import RunSession, to_scalars


class ThesisTrackerCallback(keras.callbacks.Callback):
    def __init__(
        self,
        name: str | None = None,
        *,
