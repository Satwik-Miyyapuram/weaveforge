...
**Build plan:** `[future-work/competitive-scan-implementation-plan.md](future-work/competitive-scan-implementation-plan.md)` (phased delivery + docs).
...
**Status:** #1–3, #5–7, #10 and the board half of #12 shipped in [PR #29](https://github.com/Satwik-Miyyapuram/thesis_tracker/pull/29); #9 shipped in [PR #33](https://github.com/Satwik-Miyyapuram/thesis_tracker/pull/33). #4, #8, #11 and the Notion relation/rollup idea are implemented on `feat/library-knowledge-loop` ([`future-work/library-knowledge-loop-plan.md`](future-work/library-knowledge-loop-plan.md)), which also replaces the `Excerpts/` vault notes with annotation cards under each paper.
