...
Apply every file in [`supabase/migrations/`](../supabase/migrations/) on your Postgres (through latest — E2EE needs `0037+`), then [`supabase/migrations-self-hosted-postgres/`](../supabase/migrations-self-hosted-postgres/). See [`storage/migration-plan.md`](../storage/migration-plan.md).
