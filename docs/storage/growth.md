...
|---|---|---|
| `experiment_metrics` | downsampling on write, then chunked storage | **Done** — see [the plan](../future-work/metrics-storage-plan.md). 448.7 → 22.5 B/point, and a run's footprint is now logarithmic in its length |
