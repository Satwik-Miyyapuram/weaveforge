...
- Account
- Appearance / themes (Catppuccin latte/frappe/mocha, amoled, control size — see `docs/themes.md`)
...
Internal scan lives in `docs/competitive-scan.md`. High-level takeaways already decided:
...
| `docs/DESIGN.md` | Architecture / SOLID |
