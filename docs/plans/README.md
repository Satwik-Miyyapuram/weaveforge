...
| Plan | Notes |
|------|-------|
| [`roadmap-2026-07-phased.md`](current/roadmap-2026-07-phased.md) | Competitive roadmap phases A–F; E done, F next |
...
| [`pdf-viewer-plan.md`](completed/pdf-viewer-plan.md) | Read-only pdf.js reader + provenance (Phase D) |
