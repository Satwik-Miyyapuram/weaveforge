...
| # | Work | Accept | Status |
|---|------|--------|--------|
| 5.1 | User-facing usage guide: excerpts, cite, Overleaf `\cite`, related papers | `docs/usage-cite-and-excerpts.md` | Done |
| 5.2 | Update `docs/dev.md`, `docs/integrations.md` pointers | Linked from competitive scan | Done |
