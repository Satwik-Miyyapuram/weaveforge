...
Both predate the verified competitive research, so neither accounts for ZotFlow, the Weights & Biases downgrade, or Elicit's extraction ceiling. Two newer plans cover single features in depth ([`../completed/pdf-viewer-plan.md`](../completed/pdf-viewer-plan.md), [`../../future-work/billing-and-quota-plan.md`](../../future-work/billing-and-quota-plan.md)) but neither sequences the roadmap as a whole. This document is the missing layer above them.
