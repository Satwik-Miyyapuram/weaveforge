...
**Date:** 2026-07-25
**Status:** Strategy. Supersedes the "Suggested launch tiers" table in `docs/plans/completed/COMMERCIALIZATION_AND_COST_PLAN.md`; that document's cost analysis, OCI decision, and cost-control checklist remain authoritative.
...
- `docs/plans/completed/COMMERCIALIZATION_AND_COST_PLAN.md` — cost drivers, OCI decision, pre-launch cost controls (still authoritative; its tier table is superseded by §5 here)
- `docs/plans/completed/hosting-and-cost-plan.md` — licensing boundary between hosted and self-hosted
