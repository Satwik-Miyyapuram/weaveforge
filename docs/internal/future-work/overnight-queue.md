...
- `docs/building/design.md` — section 4, the SOLID rules for this codebase
- `docs/building/dev.md` — "SOLID boundaries (enforced in CI)"
...
**Spec:** `docs/internal/plans/completed/pdf-viewer-plan.md` §5.1, §5.2, Phase 0.
...
**Spec:** `docs/internal/plans/completed/pdf-viewer-plan.md` §5.1 and §4.1 of `docs/internal/strategy/competitive-findings-2026-07.md`.
...
Task 2 shipped without the normalisation the spec required. `findQuoteMatches` uses raw `text.indexOf(exact)`, so a quote captured from one PDF text extraction will not match text from another — different pdf.js version, different line-breaking, collapsed or expanded spaces. The **primary** anchor then silently degrades to the position fallback, which the W3C spec itself calls "very brittle". This defeats the reason quote selectors are primary at all, and is the anchor-rot risk named in `docs/internal/plans/completed/pdf-viewer-plan.md` §9.
...
**Spec:** `docs/internal/strategy/competitive-findings-2026-07.md` §4.2.
...
**Spec:** `docs/internal/strategy/competitive-findings-2026-07.md` §6, P1 "Multi-format citation insertion".
...
**Spec:** `docs/internal/plans/completed/pdf-viewer-plan.md` §5.1, "Two anchors, not one".
...
**Spec:** `docs/internal/plans/completed/pdf-viewer-plan.md` §4.
...
**Spec:** `docs/internal/plans/completed/roadmap-2026-07-phased.md` Phase B, "vault note templates".
...
**Spec:** `docs/internal/plans/completed/roadmap-2026-07-phased.md` Phase B, "artifact-to-report pinning".
...
Append a short summary to `docs/internal/future-work/overnight-notes.md`: which tasks completed, which were skipped and why, and anything a human should check. Commit it. Do not push.
