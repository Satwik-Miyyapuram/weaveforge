...
**Researched.** Written up in full as `docs/internal/plans/future/interop-surface.md`.
...
Planned in `docs/internal/plans/future/interop-tiers.md`, all six done, on branch
`feat/interop-tiers`.
