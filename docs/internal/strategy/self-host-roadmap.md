...
**The whole shift lives in one document: [`backend/oracle-shift-guide.md`](../../running/oracle-shift.md).** Fresh OCI account through to cutover — VM, firewall, containers, schema, data copy, the one variable that flips it, and the troubleshooting. Nothing else to open.
...
| **3 OCI infra** | 🔨 **Your turn** | VM + Postgres + PostgREST + MinIO — [`oracle-shift-guide.md`](../../running/oracle-shift.md) Stage 1 |
...
Open **[`docs/running/oracle-shift.md`](../../running/oracle-shift.md)** and work down it, top to bottom. Stage 1 is the console clicking; stages 2 and 3 are the data and the cutover.
...
| Phase | Doc | Work |
|-------|-----|------|
| 4 Shadow migrate | [`oracle-shift-guide.md`](../../running/oracle-shift.md) Stage 2 | `npm run migrate` — preflight, schema, copy, verify. Blobs: `npm run migrate:blobs`. Reads from Supabase, never writes. |
| 5 Cutover | [`oracle-shift-guide.md`](../../running/oracle-shift.md) Stage 3 | Vercel env: `NEXT_PUBLIC_DATA_URL` → your PostgREST. Leave `NEXT_PUBLIC_BACKEND_PROVIDER=supabase`; keep Supabase Auth |
| 6 Tiering | [`storage/tiering.md`](../../running/storage/tiering.md) | Cron when R2 fills |
...
| Topic | Path |
|-------|------|
| **This index** | `docs/internal/strategy/self-host-roadmap.md` |
| **The shift — everything, one doc** | [`docs/running/oracle-shift.md`](../../running/oracle-shift.md) |
| Phase plan | [`docs/internal/plans/completed/migration-plan.md`](../plans/completed/migration-plan.md) |
| Postgres provider | [`docs/running/postgres-provider.md`](../../running/postgres-provider.md) |
| R2 setup | [`docs/running/storage/r2-setup.md`](../../running/storage/r2-setup.md) |
| Migrations layout | [`supabase/README.md`](../../../supabase/README.md) |
| Backend overview | [`docs/running/backend.md`](../../running/backend.md) |
...
2. ~~**Phase 4 scripts**~~ — done and verified: `npm run migrate:preflight | migrate:schema | migrate:data | migrate:verify | migrate:blobs`, written up in [`oracle-shift-guide.md`](../../running/oracle-shift.md) Stage 2. This gets a **verified replica** onto OCI. It does **not** cut over — see below.
