...
**Driver:** ZotFlow ships an embedded reader inside Obsidian and is rated our leading competitive threat — see `docs/internal/strategy/competitive-findings-2026-07.md` §2.1. Separately, the `/ai-review` provenance UI (P0) needs a way to show the source of an AI claim without a context break.
...
| How is it themed? | Must accept the Catppuccin themes (`docs/building/themes.md`) |
...
Design per the verified spec work in `docs/internal/strategy/competitive-findings-2026-07.md` §4.1:
...
- Dark-mode rendering that respects the Catppuccin themes (`docs/building/themes.md`)
...
| Templated source notes | LiquidJS, with **persistent and editable regions** so re-render does not clobber user edits | Planned **elsewhere** | Vault note templates — P0 in `docs/internal/strategy/competitive-findings-2026-07.md` §6. *Adopt the editable-region mechanic; it is the hard part* |
...
- `docs/internal/strategy/competitive-findings-2026-07.md` — §2.1 ZotFlow teardown, §4.1 anchor design, §6 roadmap
- `docs/internal/strategy/deep-research-brief.md` — §6.1 papers, §6.17 storage/PWA, §11 non-goals (amend per §2 above)
- `docs/running/storage/tiering.md` — existing tiering design
