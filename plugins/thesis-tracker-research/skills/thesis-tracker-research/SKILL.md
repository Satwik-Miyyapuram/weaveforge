---
name: thesis-tracker-research
description: Help a researcher work with Thesis Tracker through explicitly authorised MCP sources while preserving end-to-end encryption and review-controlled writes.
---

# Thesis Tracker research workflow

Use this workflow when the user asks to analyse, compare, organise, or add to
research material in Thesis Tracker.

## Non-negotiable access boundary

Only use a Thesis Tracker MCP tool after the user has explicitly connected and
...
5. Do not claim to have read PDFs; Thesis Tracker provides metadata, notes, and
