# Thesis Tracker Research Codex plugin

This plugin gives Codex an explicitly authorised, end-to-end encrypted path to
selected Thesis Tracker sources. It works only while an unlocked Thesis Tracker
...
1. In Thesis Tracker, open **Settings → AI assistant access** and enable it.
...
```text
THESIS_TRACKER_MCP_URL=https://your-thesis-tracker.example.com
THESIS_TRACKER_MCP_TOKEN=tt_...
THESIS_TRACKER_MCP_SESSION=<session ID from Thesis Tracker>
THESIS_TRACKER_MCP_PAIRING_SECRET=<pairing secret from Thesis Tracker>
```
...
only that secret in your Thesis Tracker settings.
...
Install `thesis-tracker-research` from that marketplace, then start a new Codex
