 ...
 * Android builds are tagged `android-vN` (the number is the Play version code)
 * and the Python SDK `py-v0.6.0`, and either would otherwise sort as the newest
 * thing on offer — sending a desktop reader to download an APK, or a wheel.
 */
