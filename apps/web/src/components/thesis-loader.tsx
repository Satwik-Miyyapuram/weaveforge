...
function ThesisLoaderMark({ compact }: { compact?: boolean }) {
  return (
    <div
      className={`thesis-loader-mark${compact ? " thesis-loader-mark--compact" : ""}`}
      aria-hidden
    >
      <span className="thesis-loader-orbit thesis-loader-orbit--a" />
      <span className="thesis-loader-orbit thesis-loader-orbit--b" />
      <span className="thesis-loader-orbit thesis-loader-orbit--c" />
      <span className="thesis-loader-orbit thesis-loader-orbit--d" />
      <span className="thesis-loader-core">
        <span className="dot" />
      </span>
    </div>
  );
...
export function ThesisLoader({
  ...
  return (
    ...
    >
      ...
      {!inline && <p className="thesis-loader-brand">WeaveForge</p>}
      <p className="thesis-loader-status">{status}</p>
      {showTips ? (
        <div
          className={`thesis-loader-tip${tipVisible ? " thesis-loader-tip--in" : ""}`}
          key={tipIndex}
        >
...
export function ThesisLoaderScreen(props: Omit<ThesisLoaderProps, "variant" | "markAuthLoading">) {
  return (
    <main className="app-shell thesis-loader-screen">
...
export function ScreenLoader({
  ...
  return (
    <div className={`thesis-loader-wrap${compact ? " thesis-loader-wrap--compact" : ""}`}>
      <ThesisLoader
        variant="inline"
        status={status}
        showTips={showTips}
