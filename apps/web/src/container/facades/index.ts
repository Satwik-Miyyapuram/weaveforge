...
import type { LibraryTidyFacade } from "./library-tidy";
...
export interface AppContainer {
  ...
  /** Placeholder titles and duplicate papers left by older imports. */
  libraryTidy: LibraryTidyFacade;
