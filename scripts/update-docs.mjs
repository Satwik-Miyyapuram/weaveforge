 ...
 */
const BLOCKS = [
  { id: "code-map", doc: "docs/building/architecture-map.md", build: codeMap },
  { id: "desktop-ipc", doc: "docs/building/architecture-map.md", build: desktopIpc },
  { id: "mcp-tools", doc: "docs/building/mcp.md", build: mcpTools },
  { id: "boundary-checks", doc: "docs/building/dev.md", build: boundaryChecks },
];
